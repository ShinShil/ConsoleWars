...
/**
 * animaiton for skills should start the animation and handle the end of the animation
 * 
 * @author ShinShil
 *
 */
public abstract class AnimationSkill implements INamedObject {
  ...
  public void setReplay(boolean replayFlag) {
  ...
  public void stopBot() throws NoSuchMethodException, SecurityException, ClassNotFoundException,
